                        ...
                        <div id="invoice-bot">
                            ...
                            <div id="table">
                                ...
                                @foreach($detailPedido as $detalle)
                                    <tr class="service">
                                        <td class="tableitem"><p class="itemtext">{{$detalle->pintura->nombre}}</p></td>
                                        <td class="tableitem"><p class="itemtext">{{$detalle->cantidad}}</p></td>
                                        <td class="tableitem"><p class="itemtext">{{$detalle->pintura->precioUnit}}</p></td>
